...
<body class="min-h-screen bg-gray-100 flex items-center justify-center p-4">
    <div class="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
        ...
        <p class="text-sm text-gray-500 mt-1">Register with phone/email/password. Telegram OTP is required before account creation.</p>
        <p class="text-xs text-gray-400 mt-1">First: open your bot, press /start, then share contact or send: /link +855xxxxxxxx.</p>
        ...
        <form method="POST" action="{{ route('register.store') }}" class="mt-6 space-y-4">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1" for="password_confirmation">Confirm
                    password</label>
